namespace WHC.OrderWater.Commons
{
    ...
    public class PinYinUtil
    {
        ...
        public static string GetFirstPY(string chsStr)
        {
            ...
            foreach (char ch in chsStr.ToCharArray())
            {
                builder.Append(smethod_4(ch.ToString()));
            }
            return builder.ToString();
        }

        public static string smethod_0(string chs, string separator, bool initialCap)
        {
            ...
            {
                chs = chs.Replace(entry.Key.ToString(), string.Format("\r\r\r{0}\r\r\r", entry.Value.ToString().Replace(" ", separator)));
            }
            ...
            return str2.Replace("\r\r\r", separator);
        }

        public static string smethod_1(string chs, string separator)
        {
            return smethod_0(chs, separator, false);
        }

        public static string smethod_2(string chs, bool initialCap)
        {
            return smethod_0(chs, "", initialCap);
        }

        public static string smethod_3(string chs)
        {
            return smethod_1(chs, "");
        }

        private static string smethod_4(string string_1)
        {
            if (string_1.CompareTo("吖") < 0)
            {
                string s = string_1.Substring(0, 1).ToUpper();
            ...
            if (string_1.CompareTo("八") < 0)
            {
                return "A";
            }
            if (string_1.CompareTo("嚓") < 0)
            {
                return "B";
            }
            if (string_1.CompareTo("咑") < 0)
            {
                return "C";
            }
            if (string_1.CompareTo("妸") < 0)
            {
                return "D";
            }
            if (string_1.CompareTo("发") < 0)
            {
                return "E";
            }
            if (string_1.CompareTo("旮") < 0)
            {
                return "F";
            }
            if (string_1.CompareTo("铪") < 0)
            {
                return "G";
            }
            if (string_1.CompareTo("讥") < 0)
            {
                return "H";
            }
            if (string_1.CompareTo("咔") < 0)
            {
                return "J";
            }
            if (string_1.CompareTo("垃") < 0)
            {
                return "K";
            }
            if (string_1.CompareTo("嘸") < 0)
            {
                return "L";
            }
            if (string_1.CompareTo("拏") < 0)
            {
                return "M";
            }
            if (string_1.CompareTo("噢") < 0)
            {
                return "N";
            }
            if (string_1.CompareTo("妑") < 0)
            {
                return "O";
            }
            if (string_1.CompareTo("七") < 0)
            {
                return "P";
            }
            if (string_1.CompareTo("亽") < 0)
            {
                return "Q";
            }
            if (string_1.CompareTo("仨") < 0)
            {
                return "R";
            }
            if (string_1.CompareTo("他") < 0)
            {
                return "S";
            }
            if (string_1.CompareTo("哇") < 0)
            {
                return "T";
            }
            if (string_1.CompareTo("夕") < 0)
            {
                return "W";
            }
            if (string_1.CompareTo("丫") < 0)
            {
                return "X";
            }
            if (string_1.CompareTo("帀") < 0)
            {
                return "Y";
            }
            if (string_1.CompareTo("咗") < 0)
            {
                return "Z";
            }
            return "0";
        ...
        public static Hashtable CHSPhraseSpecial
        {
            get
            {
                if (hashtable_0 == null)
                {
                    ...
                    hashtable_0.Add("重庆", "Chong Qing");
                    hashtable_0.Add("深圳", "Shen Zhen");
                    hashtable_0.Add("什么", "Shen Me");
                }
                return hashtable_0;
            }
            set
