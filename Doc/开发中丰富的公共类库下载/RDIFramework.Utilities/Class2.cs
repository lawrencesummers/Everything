...
internal sealed class Class2
{
    ...
    internal static Hashtable smethod_0()
    {
        if (hashtable_0 == null)
        {
            hashtable_0 = new Hashtable();
            hashtable_0.Add("吴艾伟", "Wu Ai Wei");
        }
        return hashtable_0;
    }

    internal static void smethod_1(Hashtable hashtable_1)
    {
    ...
    internal static string smethod_3(string string_2, string string_3)
    {
        return smethod_2(string_2, string_3, false);
    }

    internal static string smethod_4(string string_2, bool bool_0)
    {
        return smethod_2(string_2, "", bool_0);
    }

    internal static string smethod_5(string string_2)
    {
        return smethod_3(string_2, "");
    }

    internal static string smethod_6(string string_2)
    {
        return ((smethod_5(string_2).Length > 0) ? smethod_5(string_2).Substring(0, 1).ToUpper() : "");
    }

    internal static DataTable smethod_7(DataTable dataTable_0, string string_2)
    {
        return smethod_8(dataTable_0, string_2, "-");
    }

    internal static DataTable smethod_8(DataTable dataTable_0, string string_2, string string_3)
    {
        foreach (DataRow row in dataTable_0.Rows)
        {
            string str = row[string_2].ToString();
            row[string_2] = smethod_6(row[string_2].ToString()) + string_3 + str;
        }
        dataTable_0.DefaultView.Sort = string_2;
        return dataTable_0;
    }
}
