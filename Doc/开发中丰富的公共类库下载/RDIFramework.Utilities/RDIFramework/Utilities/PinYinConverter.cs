namespace RDIFramework.Utilities
{
    ...
    {
        private const int int_0 = -20319;
        private const int int_1 = -2050;
        private const int int_2 = -10247;
        ...
        public static string Get(char ch)
        {
            ...
            byte[] bytes = Encoding.GetEncoding("gb2312").GetBytes(ch.ToString());
            int num = ((bytes[0] * 0x100) + bytes[1]) - 0x10000;
            if ((num > 0) && (num < 160))
            {
                return ch.ToString();
            }
            ...
            if (num > -10247)
            {
                int index = Array.IndexOf<string>(string_1, ch.ToString());
                if (index != -1M)
                {
                    return string_2[index];
                }
            }
            else
            {
        ...
        public static string GetFirst(string str)
        {
            ...
            for (int i = 0; i < chArray.Length; i++)
            {
                builder.Append(GetFirst(chArray[i]));
            }
            return builder.ToString();
        }
    }
