namespace RDIFramework.Utilities
{
    ...
    public static class ClsImeHelper
    {
        ...
        {
            frm.Paint += new PaintEventHandler(ClsImeHelper.smethod_1);
            smethod_0(frm);
        }

        private static void smethod_0(Control control_0)
        {
            control_0.Enter += new EventHandler(ClsImeHelper.smethod_2);
        ...
        private static void smethod_1(Control control_0, PaintEventArgs paintEventArgs_0)
        {
            smethod_3(control_0);
        }

        private static void smethod_2(Control control_0, EventArgs eventArgs_0)
        {
            smethod_3(control_0);
        }
